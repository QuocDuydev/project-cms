...
export interface ApiPromotionPromotion extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Required &
      Attribute.DefaultTo<'free shipping'>;
    status: Attribute.Enumeration<['happen', 'finish']> &
      Attribute.Required &
      Attribute.DefaultTo<'happen'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiReviewReview extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<['unconfirmed', 'confirm']> &
      Attribute.Required &
      Attribute.DefaultTo<'unconfirmed'>;
    products: Attribute.Relation<
      'api::review.review',
      'manyToOne',
      'api::product.product'
    >;
    review_media: Attribute.Media;
